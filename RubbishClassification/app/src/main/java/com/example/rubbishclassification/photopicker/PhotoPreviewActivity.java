package com.example.rubbishclassification.photopicker;
...
import com.example.rubbishclassification.activity.BaseActivity;
import com.example.rubbishclassification.activity.MyPhotoPreViewActivity;
import com.example.rubbishclassification.photopicker.widget.ViewPagerFixed;
...
public class PhotoPreviewActivity extends BaseActivity implements PhotoPagerAdapter.PhotoViewClickListener{
    ...
    public void updateActionBarTitle() {
        setTitleText((mViewPager.getCurrentItem() + 1)+"/"+paths.size());
    }
...
//    }
    ...
    private void showDialog(){
        ...
        LayoutInflater factory = LayoutInflater.from(PhotoPreviewActivity.this);
        ...
        myDialog = new android.app.AlertDialog.Builder(this)
                .setView(view)
